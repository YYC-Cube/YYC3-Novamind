...
export class AssessmentManager {
  private static readonly QUIZZES_KEY = "novamind-quizzes"
  private static readonly QUIZ_ATTEMPTS_KEY = "novamind-quiz-attempts"
  private static readonly SKILL_ASSESSMENTS_KEY = "novamind-skill-assessments"
  private static readonly CERTIFICATES_KEY = "novamind-certificates"
  private static readonly PORTFOLIOS_KEY = "novamind-portfolios"
  ...
  static generateCertificate(
    ...
    const certificate: Certificate = {
      ...
      achievements,
      credentialUrl: `https://novamind.yyc3.com/certificates/${Date.now()}`,
    }
