...
interface ContentDetail {
  ...
  title: string
  content: string
  type: "experience" | "search-result" | "learning-path" | "mindmap" | "conversation" | "knowledge-graph"
  tags: string[]
  createdAt: number
  updatedAt: number
  likes: number
...
interface ContentComment extends ContentReply {
  replies: ContentReply[]
}

type SharedContent = ContentDetail
type Comment = ContentComment
        ...
        <article className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
            <div className="flex items-center gap-6">
              <button
                onClick={handleLike}
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${isLiked ? "bg-red-100 text-red-600" : "hover:bg-gray-100 text-gray-600"
                  }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors ${isBookmarked ? "bg-yellow-100 text-yellow-600" : "hover:bg-gray-100 text-gray-600"
                  }`}
              >
