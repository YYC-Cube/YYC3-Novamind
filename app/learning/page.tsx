    ...
    return (
      <div className="min-h-screen bg-surface-panel flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">正在加载学习数据...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-surface-panel text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">学习中心</h1>
                <p className="text-gray-400">个性化学习路径与成就系统</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 text-gray-400 hover:text-blue-600 hover:bg-white/10 rounded-lg transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-surface-card rounded-lg p-6 shadow-sm border border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-400">学习路径</p>
            ...
            <div className="bg-surface-card rounded-lg p-6 shadow-sm border border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-400">完成步骤</p>
                  <p className="text-2xl font-bold text-white">{stats.completedSteps}</p>
                </div>
            ...
            <div className="bg-surface-card rounded-lg p-6 shadow-sm border border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-400">学习时长</p>
                  <p className="text-2xl font-bold text-white">{Math.round(stats.totalHours)}h</p>
                </div>
            ...
            <div className="bg-surface-card rounded-lg p-6 shadow-sm border border-white/10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">{stats.achievementsCount}</p>
                </div>
        ...
        {/* 标签页导航 */}
        <div className="bg-surface-card rounded-lg shadow-sm border border-white/10 mb-6">
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
                ...
                <div className="flex items-center space-x-2">
                  <button className="flex items-center space-x-2 px-3 py-2 text-gray-400 hover:text-blue-600 hover:bg-white/10 rounded-lg transition-colors">
                    <Download className="w-4 h-4" />
                    <span>导出</span>
                  </button>
                  <button className="flex items-center space-x-2 px-3 py-2 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors">
                      ...
                      <div className="space-y-2">
                        {path.steps.slice(0, 3).map((step) => (
                          <div key={step.id} className="flex items-center space-x-2">
                            ...
                            <span
                              className={`text-sm ${step.completed ? "text-gray-500 line-through" : "text-gray-200"}`}
                            >
                              {step.title}
                            </span>
                          </div>
              ...
              {filteredPaths.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 mb-4">��无匹配的学习路径</p>
                  <button
                    onClick={handleCreatePath}
                ...
                {achievements.map((achievement) => (
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3
                          className={`font-semibold mb-1 ${achievement.unlocked ? "text-yellow-800" : "text-gray-400"}`}
                        >
                          {achievement.title}
                        </h3>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-surface-panel rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-white mb-4">学习活动趋势</h3>
                    ...
                    {stats.categoryStats.map((category, index) => (
                      <div key={index} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-400 w-8">{category.count}</span>
                        </div>
                      </div>
                    ))}
                  </div>
